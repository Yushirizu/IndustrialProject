...
const pages = [{name: "Index", href: "/"}, {name: "Live", href: "/live"}, {
    name: "Historic",
    href: "/historic"
...
function ResponsiveAppBar() {
    ...
    return (<Box sx={{flexGrow: 1, m: 5, borderRadius: 100}}>
            <AppBar
                position="static"
                    ...
                    <Toolbar disableGutters>
                        ...
                        {<div>
                            ...
                            <Menu
                                ...
                                onClose={handleClose}>
                                {session?.user.isAdmin ? (<MenuItem onClick={handleClose}>Admin page</MenuItem>) : null}
