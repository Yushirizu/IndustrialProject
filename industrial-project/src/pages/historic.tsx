...
export default function SwitchesGroup() {
  ...
  return (
    <FormControl component="fieldset" variant="standard" className={classes.formControl}>
      <FormLabel component="legend" className={classes.formLabel}>Assign responsibility</FormLabel>
      ...
      <FormHelperText>Be sure to assign responsibilities correctly.</FormHelperText>
    </FormControl>
  );
}